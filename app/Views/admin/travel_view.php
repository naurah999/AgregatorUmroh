...
<body class="bg-light">
    ...
    <nav class="navbar navbar-dark mb-4" style="background-color: #0b5345;">
        <div class="container">
            ...
            <div class="d-flex">
                <a href="/admin" class="btn btn-outline-light btn-sm me-2"><i class="fas fa-box"></i> Kelola Paket</a>
                <a href="/admin/travel" class="btn btn-warning btn-sm me-3"><i class="fas fa-building"></i> Kelola Travel</a>
        ...
        <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
            <table class="table table-hover align-middle mb-0">
                ...
                <tr>
                    ...
                    <th>Kota Asal</th>
                    <th>No. SK Kemenag</th>
                    <th>Alamat Lengkap</th> <th width="15%" class="text-center">Aksi</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/admin/travel/hapus/<?= $t['id']; ?>" class="btn btn-sm btn-danger rounded-pill px-3" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                        </td>
                    </tr>
                    ...
                    <div class="modal fade" id="modalEdit<?= $t['id']; ?>" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/admin/travel/ubah/<?= $t['id']; ?>" method="post">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/admin/travel/simpan" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Nama Biro Travel</label>
